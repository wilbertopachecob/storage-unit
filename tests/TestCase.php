...
abstract class TestCase extends PHPUnitTestCase
{
    ...
    protected function resetDatabase()
    {
        ...
        $this->pdo->exec("
            INSERT INTO items (id, title, description, qty, user_id, img) VALUES 
            (1, 'Test Item 1', 'Test description for item 1', 1, 1, 'test1.jpg'),
            (2, 'Test Item 2', 'Test description for item 2', 2, 1, 'test2.jpg'),
            (3, 'Admin Item', 'Admin test item', 1, 2, 'admin.jpg')
        ");
    }
     ...
     * Create a test item
     */
    protected function createTestItem($title = 'Test Item', $description = 'Test Description', $qty = 1, $userId = 1, $img = null)
    {
        $stmt = $this->pdo->prepare("INSERT INTO items (title, description, qty, user_id, img) VALUES (?, ?, ?, ?, ?)");
        $stmt->execute([$title, $description, $qty, $userId, $img]);
        return $this->pdo->lastInsertId();
    }
